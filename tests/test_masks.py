...
@pytest.mark.parametrize("number_card", ["", "1234 4557", "1234 1234 1234 1234 1234"])
...
def test_get_mask_account_good(number_account):
    assert get_mask_account(number_account) == "**1212"


@pytest.mark.parametrize(
    "number_account, mask_account", [("1212-1212-1212-1212-1212", "**1212"), ("12345678 9098765 48345", "**8345")]
)
